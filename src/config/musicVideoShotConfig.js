...
export const MUSIC_VIDEO_SHOT_TYPE_OPTIONS = Object.freeze([
  {
    ...
    talkingHeadLoraStrength: 0.6,
    cameraLoraOn: false,
    cameraLoraStrength: 0.3,
    defaultImageStrength: 1,
    promptSuffix: 'The artist performs, lip-syncing naturally to the attached vocals. Believable facial performance with visible mouth shapes matching the sung words. Maintain the same singer identity, facial expression style, performance energy, and mouth articulation across this performance sequence. Natural singing delivery, stable head and body motion, no sudden acting style changes.',
  ...
  },
  {
    ...
    talkingHeadLoraOn: true,
    talkingHeadLoraStrength: 0.4,
    cameraLoraOn: false,
    cameraLoraStrength: 0.3,
    defaultImageStrength: 1,
    promptSuffix: 'The artist performs in a wider shot, natural body motion, lip-sync present but not emphasized, with mouth movement following the sung words. Maintain the same singer identity, performance energy, and mouth articulation across this performance sequence. Stable head and body motion, no sudden acting style changes.',
    needsVocalAlignment: true,
  },
  {
    id: 'b_roll',
