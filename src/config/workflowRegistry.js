...
export const BUILTIN_WORKFLOWS = [
  ...
  { id: 'music-video-shot-ltx23-16gb', label: 'Music Video Shot (LTX 2.3 FP8 - 16GB)', category: 'video', needsImage: true, description: 'Per-shot I2V with audio, optimized for 16GB VRAM using LTX 2.3 1.1 MXFP8, SageAttention3, and chunks 4 / dim 4096', file: 'music_video_shot_ltx2_3_i2v_audio_16gb.json' },
