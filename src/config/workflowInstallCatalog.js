...
export const CURATED_NODE_PACKS = Object.freeze([
  createAutoNodePack({
    ...
    requirementsStrategy: 'requirements-txt',
    notes: 'Provides KJ helper nodes and the optional SageAttention patch node used by bundled local video workflows.',
    classTypes: ['ImageResizeKJv2', 'GetImagesFromBatchIndexed', 'SimpleCalculatorKJ', 'LazySwitchKJ', 'PathchSageAttentionKJ'],
  }),
  createAutoNodePack({
    id: 'comfyui-gguf',
    ...
    requirementsStrategy: 'requirements-txt',
    notes: 'Provides GGUF model loaders used by the compatible Low VRAM music-video workflow.',
    classTypes: ['UnetLoaderGGUF', 'DualCLIPLoaderGGUF', 'CLIPLoaderGGUF'],
  }),
  createAutoNodePack({
    id: 'ltxvideo',
...
export const MODEL_INSTALL_RECIPES = Object.freeze({
  ...
  [modelKey('text_encoders', 'gemma_3_12B_it_fp8_e4m3fn.safetensors')]: createModelRecipe({
    filename: 'gemma_3_12B_it_fp8_e4m3fn.safetensors',
    targetSubdir: 'text_encoders',
    displayName: 'Gemma 3 12B FP8 E4M3FN text encoder',
    downloadUrl: hfResolve('GitMylo/LTX-2-comfy_gemma_fp8_e4m3fn', 'gemma_3_12B_it_fp8_e4m3fn.safetensors'),
    sourceUrl: hfBlob('GitMylo/LTX-2-comfy_gemma_fp8_e4m3fn', 'gemma_3_12B_it_fp8_e4m3fn.safetensors'),
    licenseUrl: 'https://huggingface.co/google/gemma-3-12b-it-qat-q4_0-unquantized',
    notes: 'FP8 Gemma text encoder used by the 16GB LTX 2.3 music-video workflow.',
  }),
  [modelKey('text_encoders', 'gemma-3-12b-it-IQ4_XS.gguf')]: createModelRecipe({
    filename: 'gemma-3-12b-it-IQ4_XS.gguf',
    targetSubdir: 'text_encoders',
    displayName: 'Gemma 3 12B IQ4_XS GGUF text encoder',
    downloadUrl: hfResolve('bartowski/gemma-3-12b-it-GGUF', 'gemma-3-12b-it-IQ4_XS.gguf'),
    sourceUrl: hfBlob('bartowski/gemma-3-12b-it-GGUF', 'gemma-3-12b-it-IQ4_XS.gguf'),
    licenseUrl: 'https://huggingface.co/google/gemma-3-12b-it',
    notes: 'GGUF text encoder used by the compatible Low VRAM LTX 2.3 music-video workflow.',
  }),
  [modelKey('text_encoders', 'ltx-2.3_text_projection_bf16.safetensors')]: createModelRecipe({
    filename: 'ltx-2.3_text_projection_bf16.safetensors',
    targetSubdir: 'text_encoders',
    displayName: 'LTX 2.3 text projection BF16',
    downloadUrl: hfResolve('Kijai/LTX2.3_comfy', 'text_encoders/ltx-2.3_text_projection_bf16.safetensors'),
    sourceUrl: hfBlob('Kijai/LTX2.3_comfy', 'text_encoders/ltx-2.3_text_projection_bf16.safetensors'),
    licenseUrl: 'https://huggingface.co/Kijai/LTX2.3_comfy',
    notes: 'Projection weights paired with Gemma for the LTX 2.3 text encoder.',
  }),
  [modelKey('diffusion_models', 'ltx-2.3-22b-distilled-1.1_transformer_only_mxfp8_block32.safetensors')]: createModelRecipe({
    filename: 'ltx-2.3-22b-distilled-1.1_transformer_only_mxfp8_block32.safetensors',
    targetSubdir: 'diffusion_models',
    displayName: 'LTX 2.3 22B Distilled 1.1 MXFP8 block32 diffusion model',
    downloadUrl: hfResolve('Kijai/LTX2.3_comfy', 'diffusion_models/ltx-2.3-22b-distilled-1.1_transformer_only_mxfp8_block32.safetensors'),
    sourceUrl: hfBlob('Kijai/LTX2.3_comfy', 'diffusion_models/ltx-2.3-22b-distilled-1.1_transformer_only_mxfp8_block32.safetensors'),
    licenseUrl: 'https://huggingface.co/Kijai/LTX2.3_comfy',
    notes: 'MXFP8 v1.1 transformer used by the 16GB LTX 2.3 music-video workflow.',
  }),
  ...
  [modelKey('unet', 'LTX-2.3-22B-distilled-1.1-Q6_K.gguf')]: createModelRecipe({
    ...
    licenseUrl: 'https://huggingface.co/Lightricks/LTX-2.3',
    notes: 'GGUF diffusion model used by the compatible Low VRAM music-video workflow; ComfyUI-GGUF can offload part of the model to system RAM.',
  }),
